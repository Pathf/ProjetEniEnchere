	...
	<div class="container text-center">
		...
		<form method="get" action="encheres">
			...
			<input 	name="filtres"
					...
					placeholder="${defaultFiltresPlaceHolder!= null ? defaultFiltresPlaceHolder:'le nom de l\'article contient'}"
					aria-label="Search"
				...
				<c:when test="${pseudo != null}">
					<div class="d-flex justify-content-around">
						<div class="form-check">
							<input class="form-check-input" type="radio" name="radioAchatVente" id="exampleRadios1" value="achat" >
							<label class="form-check-label" for="exampleRadios1">Achat(s)</label>
							<div class="form-check">
								<input class="form-check-input" name="checkboxAchat" type="checkbox" value="open" id="defaultCheck1">
								<label class="form-check-label" for="defaultCheck1">Enchères ouvertes</label>
							</div>
							<div class="form-check">
								<input class="form-check-input"  name="checkboxAchat" type="checkbox" value="mine" id="defaultCheck2">
								<label class="form-check-label"	for="defaultCheck2">Mes enchères</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" name="checkboxAchat" type="checkbox" value="win" id="defaultCheck3">
								<label class="form-check-label"	for="defaultCheck3">Mes enchères remportées</label>
							</div>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="radioAchatVente" id="exampleRadios2" value="vente">
							<label class="form-check-label" for="exampleRadios2">Vente(s)</label>
							<div class="form-check">
								<input class="form-check-input" name="checkboxVente" type="checkbox" value="process" id="defaultCheck4">
								<label class="form-check-label" for="defaultCheck4">Mes ventes en cours</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" name="checkboxVente" type="checkbox" value="start" id="defaultCheck5">
								<label class="form-check-label" for="defaultCheck5">Ventes non débutées</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" name="checkboxVente" type="checkbox" value="finish" id="defaultCheck6">
