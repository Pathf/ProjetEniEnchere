		...
		<div class="d-flex flex-column flex-column-reverse-xs">
			...
			<Form class="d-flex" method="get" action="encheres">
				...
				<div class="text-left w-100 searchModule">
					<input name="filtres" type="search"
						class="form-control rounded mb-3 rounded"
					...
					<div class="block">
						...
						<label for="categorie">Catégorie </label> <select name="categorie"
							class="custom-select custom-select-lg mb-3 w-75 float-right">
					...
					<c:choose>
						<c:when test="${pseudo != null}">
							<div
								class="d-flex justify-content-around mt-3 float-left blockRadioButton">
								<div class="form-check">
									<input class="form-check-input ml-0" type="radio"
										name="radioAchatVente" id="exampleRadios1" value="achat">
									<label class="form-check-label" for="exampleRadios1">
										Achat </label>
									<div class="ml-5">
										<div class="form-check">
											<input class="form-check-input" name="checkboxAchat"
												type="checkbox" value="open" id="defaultCheck1"> <label
												class="form-check-label" for="defaultCheck1">
												enchères ouvertes </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" name="checkboxAchat"
												type="checkbox" value="mine" id="defaultCheck2"> <label
												class="form-check-label" for="defaultCheck2"> mes
												enchères </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" name="checkboxAchat"
												type="checkbox" value="win" id="defaultCheck3"> <label
												class="form-check-label" for="defaultCheck3"> mes
								...
								<div class="form-check">
									<input class="form-check-input ml-0" type="radio"
										name="radioAchatVente" id="exampleRadios2" value="vente">
									<label class="form-check-label" for="exampleRadios2">
										Vente </label>
									<div class="ml-5">
										<div class="form-check">
											<input class="form-check-input" name="checkboxVente"
												type="checkbox" value="process" id="defaultCheck4">
											<label class="form-check-label" for="defaultCheck4">
												mes ventes en cours </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" name="checkboxVente"
												type="checkbox" value="start" id="defaultCheck5"> <label
												class="form-check-label" for="defaultCheck5"> ventes
												non débutées </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" name="checkboxVente"
												type="checkbox" value="finish" id="defaultCheck6"> <label
												class="form-check-label" for="defaultCheck6"> ventes
												terminées </label>
										</div>
									</div>
								</div>
